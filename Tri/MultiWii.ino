...
int LS = LOW;             // ledState used to set the LED
long pM = 0;        // will store last time LED was updated
long iv = 1000;           // interval at which to blink (milliseconds)
...
void loop () {
  ...
  //jc
  SetupRedLEDPinDirection();
  SetupRedLEDBlinkingRate();
  
  SetupYellowLEDPinDirection();
  SetupYellowLEDBlinkingRate();
...
//jc
void SetBlinkRateofRedLED (int blinkrate)
{
  interval = blinkrate;
}

void SetBlinkRateofYellowLED (int blinkrate)
{
  iv = blinkrate;
}
